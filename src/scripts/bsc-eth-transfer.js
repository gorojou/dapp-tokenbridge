...
export var Bsctransfer = async (amount) => {
  ...
  let nonce = web3.utils.toHex(
    web3.eth.getTransactionCount("0x279c4f664eecd154e4130db017c956649b1ee4ae")
  );
  ...
  const bridgeBsc = new web3.eth.Contract(
    BridgeBsc.abi,
    "0x279c4f664eecd154e4130db017c956649b1ee4ae",
    options
  );
  ...
  await bridgeBsc.methods
    .burn(accounts[0], amount, nonce, signature)
