      ...
      <div className="select-bridge-container">
        ...
        <div className="brdige-selection-grid">
          ...
          >
            ...
            <img src={nets[0].logo.src} className="token-logo" alt="" />
            <span className="material-icons">swap_horiz</span>
            <img src={nets[1].logo.src} className="token-logo" alt="" />
          ...
          <div className="bridge-selection-item">
            ...
            <img src={nets[1].logo.src} className="token-logo" alt="" />
            <span className="material-icons">swap_horiz</span>
            <img src={nets[2].logo.src} className="token-logo" alt="" />
            <h2>Fantom</h2>
          ...
          <div className="bridge-selection-item">
            ...
            <img src={nets[1].logo.src} className="token-logo" alt="" />
            <span className="material-icons">swap_horiz</span>
            <img src={nets[3].logo.src} className="token-logo" alt="" />
            <h2>Avalanche</h2>
            <div className="blocked-net-list-item"></div>
          </div>
          <div className="bridge-selection-item">
            ...
            <img src={nets[1].logo.src} className="token-logo" alt="" />
            <span className="material-icons">swap_horiz</span>
            <img src={nets[4].logo.src} className="token-logo" alt="" />
            <h2>Matic</h2>
            <div className="blocked-net-list-item"></div>
          </div>
          <div className="bridge-selection-item">
            ...
            <img src={nets[1].logo.src} className="token-logo" alt="" />
            <span className="material-icons">swap_horiz</span>
            <img src={nets[5].logo.src} className="token-logo" alt="" />
            <h2>Tron</h2>
            <div className="blocked-net-list-item"></div>
          </div>
        </div>
